    ...
    <div className='min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-200'>
      ...
      <main className='mx-auto max-w-6xl px-6 py-8 space-y-8'>
        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-6 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 shadow-sm relative overflow-hidden'>
          ...
          <div className='space-y-1.5 relative z-10'>
            ...
            <p className='text-sm text-zinc-500 dark:text-zinc-450'>
              You have <span className='font-semibold text-indigo-600 dark:text-indigo-400'>{assignments.length} assignments</span> due this week and <span className='font-semibold text-rose-600 dark:text-rose-400'>{exams.length} upcoming exams</span>.
            </p>
          </div>
        </div>
              ...
              <div className='space-y-3'>
                {todayTasks.length === 0 ? (
                  <div className='flex flex-col items-center justify-center py-6 text-center text-zinc-400 dark:text-zinc-500'>
                    ...
                    <p className='text-sm mt-1 font-medium'>No Tasks Pending for Today</p>
                  </div>
                ) : (
            ...
            <section className='rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-shadow duration-300'>
              <div className='flex items-center justify-between pb-4 mb-4 border-b border-zinc-100 dark:border-zinc-800'>
                <div className='flex items-center gap-2'>
                  ...
                  <h2 className='text-lg font-bold tracking-tight'>Recommended Tasks</h2>
                </div>
              </div>
              <div className='space-y-4'>
                <ul className='space-y-2.5'>
                  {pendingTasks.slice(0, 4).map((task) => (
                    ...
                    >
                      <span className='text-sm font-semibold text-zinc-800 dark:text-zinc-200'>{task.title}</span>
          ...
          <div className='space-y-6'>
            ...
            <section className='rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-shadow duration-300'>
              ...
              <div>
                {todayExams.length === 0 ? (
                  <div className='flex flex-col items-center justify-center py-6 text-center text-zinc-400 dark:text-zinc-500'>
                    <p className='text-2xl'>🎉</p>
                    <p className='text-sm mt-1 font-medium'>No Exams Scheduled</p>
                  </div>
                ) : (
                  <ul className='space-y-2.5'>
                    {todayExams.map((exam) => (
                      ...
                      >
                        <span className='text-sm font-bold text-zinc-800 dark:text-zinc-200'>{exam.subjectName}</span>
                        <span className='text-xs text-zinc-500 dark:text-zinc-450'>
            ...
            <section className='rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-shadow duration-300'>
              ...
              <div className='flex h-32 items-center justify-center rounded-xl border border-dashed border-zinc-200 dark:border-zinc-800 text-zinc-400 dark:text-zinc-500'>
                <span className='text-xs font-medium'>Calendar widget loaded</span>
              </div>
            </section>
            ...
            <section className='rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-shadow duration-300'>
              ...
              <div className='space-y-4'>
                <div className='flex justify-between items-center text-sm font-medium'>
                  ...
                  <span className='text-zinc-800 dark:text-zinc-200'>12 / 20 hours</span>
                </div>
        ...
        <section className='rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-shadow duration-300'>
          ...
          <div className='flex h-20 items-center justify-center rounded-xl border border-dashed border-zinc-200 dark:border-zinc-800 text-zinc-400 dark:text-zinc-500'>
            <span className='text-xs font-medium'>Activity tracker loaded</span>
          </div>
        </section>
      </main>
    </div>
